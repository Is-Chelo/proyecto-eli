...
router.use('/plan-estudios', require('./plan_estudios.route'));
...
router.use('/notas-carreras', require('./notas_carreras.route'));
router.use('/notas', require('./notas.route'));
router.use('/asignaturas', require('./asignaturas.route'));
router.use('/asistencias', require('./asistencias.route'));
router.use('/asistencias-carreras', require('./asistencias_carreras.route'));
...
router.use('/colores', require('./colores.route'));
